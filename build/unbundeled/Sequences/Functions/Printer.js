...
export function printSequenceExpression(seqEx) {
    const stringBuilder = [];
...
export function printExpressionAsString(repEx) {
...
export function printExpressionAsMathML(ex) {
    function helper(ex) {
...
export function printSequenceExpressionAsMathML(seqEx) {
